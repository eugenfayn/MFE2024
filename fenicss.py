...
st.subheader('1. Автоматизация процесса решения УЧП:')
...
st.subheader('2. Генерация и оптимизация кода:')
...
st.subheader('3. Модульность и расширяемость:')
...
st.subheader('4. Совместимость с другими пакетами:')
...
plot(mesh3D)
pyplot.show ()""")
image = open('pages/img/mesh.jpg', 'rb').read()
